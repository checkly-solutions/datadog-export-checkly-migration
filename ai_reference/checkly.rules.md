...
new DnsMonitor("example-dns-monitor", {
  ...
  request: {
    ...
    assertions: [DnsAssertionBuilder.responseCode().equals("NOERROR")],
  },
...
export const testEmailAlert = new EmailAlertChannel(
  "example-email-alert-channel",
  {
...
export const testUserPhoneCallAlert = new PhoneCallAlertChannel(
  "example-call-alert-channel",
  {
    name: "Test User",
...
export const generalSlackAlert = new SlackAlertChannel(
...
export const exampleService = new StatusPageService(
  "example-status-page-service",
  {
    name: "Example Service",
  }
);
...
export const examplePrivateLocation = new PrivateLocation(
