...
A few advanced assertion types may need a manual follow-up. Your AI assistant can help you port those, and the [Checkly docs](https://www.checklyhq.com/docs/) cover the assertion API.

## Checkly docs

To go deeper on the platform itself, these are good starting points:

- [What is Checkly](https://www.checklyhq.com/docs/what-is-checkly/)
- [Checkly Skills and AI](https://www.checklyhq.com/docs/ai/skills/)
- [Monitoring as Code](https://www.checklyhq.com/docs/concepts/monitoring-as-code/)
- [Checkly CLI](https://www.checklyhq.com/docs/cli/overview/)

Tip: point your AI assistant at the Checkly docs with Context7 for fast lookups.

## Escalation order

AI assistant first → this table and `migration-report.md` → the [Checkly docs](https://www.checklyhq.com/docs/) → Checkly support. If a locator or a variable hand-off didn't translate cleanly, open an issue on the repo with the generated spec attached.
